...
namespace krtc {
	...
	public:
		...
		KRTCMsgObserver* msg_observer() { return msg_observer_; }
		void RegisterMsgObserver(KRTCMsgObserver* observer) {
			msg_observer_ = observer;
		}
	...
	private:
		...
		KRTCMsgObserver* msg_observer_ = nullptr;
	};
